...
document.addEventListener('click', async function(event) {
    ...
    if (editButton) {
        ...
        try {
            ...
            redirectUrl = `/due?tabledataId=${encodeURIComponent(tableData.tabledataId)}&deptname=${encodeURIComponent(tableData.deptname)}&screen_name=${encodeURIComponent(tableData.screen_name || "")}&columns=${encodeURIComponent(JSON.stringify(tableData.columns))}&row_data=${encodeURIComponent(JSON.stringify(tableData.row_data))}`;
